...
<div id="mine">
    @foreach($post as $value)
        <div class="row" style="">
            <a href="{{url('posts/'.$value->id.'/edit')}}" class="btn pull-right btn-success" >Edit</a>
...
<a style="margin: 10px;width: 100px;" href="{{url('/categories/create')}}" class="btn btn-success btn-sm">Add Category</a><br>
<a style="margin: 10px;width: 100px;" href="{{url('/posts/create')}}" class="btn btn-success btn-sm">Add Post</a>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.delete-category-button').click(function(){
            $('#delete_category_form').attr('action', '/categories/' + $(this).data('id'));
        });
        $('.delete-post-button').click(function(){
            $('#delete_post_form').attr('action', '/posts/' + $(this).data('idd'));
        });
    });
</script>
