...
export default class AddPostModal extends Component {
    render() {
        return (
            <div>
                <div className="modal fade" id="add-post-modal" tabIndex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content">
                            <div className="modal-body">
                                ...
                                value={this.props.post_name} onChange={this.props.getPostName} required/>
                                <textarea value={this.props.post_text} onChange={this.props.getPostText}> </textarea>
